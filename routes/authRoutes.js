...
const { register, verifyOTP, login, logout ,forgotPassword,resetPassword,getProfile,updateProfile, authenticate,userrole,isLoggedIn,myCourses, savecourse, getSavedCourses, instructorrequest, toggleSavedCourse, checkCourse, getallinstrucors, pramoteadmin, demotestudent} = require("../controllers/authController");
